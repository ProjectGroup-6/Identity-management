...
class Staff extends React.Component{
    constructor(){
     ...
     componentDidMount() {
        let self = this;
        fetch('http://localhost:5000/staffFetch', {
            method: 'GET'
     ...
     render(){
         return(
             <div>
                 ...
                 <nav id="Color" class="navbar" role="navigation" aria-label="main navigation">
                    ...
                    <aside class="menu">
                        ...
                        <ul class="menu-list">
                            ...
                            <hr class="navbar-divider" />
                            <li><a  class="is-active grey" onClick={this.StaffClick}><span class="icon"><i class="fas fa-user"></i></span> Staff Information</a></li>
                            <hr class="navbar-divider" />
                 ...
                 <br></br>
                 <h2 id="TagColor">Staff details</h2>
